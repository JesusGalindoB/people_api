...
def read_one(lname):
    ...
    Args:
        lname: last name of person to find
    Return:
...
def update(lname, person):
    ...
    Args:
        lname: last name of person to update in the people structure
...
def delete(lname):
    ...
    Args:
        lname: last name of person to delete
    Return:
